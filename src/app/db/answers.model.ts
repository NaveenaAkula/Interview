    ...
    static get answers (): Answer[] {
        return [
            ...
            },
            {
                'name': 'Five years',
                'type': 'Behaviour',
                'content': ` Well I'm really excited by this position at FNBO. I would like to be seen as someone with very good expertise and having a very good knowledge on in software industry and I know that something I will have an opportunity to do here I'm really excited to take on take upon manage responsibilities in the next few hours and also I would like to lead project and as well as I would like to help the new joinees so I have been very lucky enough to work with some of my some of the amazing managers and the seniors so that inspiration and their behavior helped me to inspire. `
            },
            {
